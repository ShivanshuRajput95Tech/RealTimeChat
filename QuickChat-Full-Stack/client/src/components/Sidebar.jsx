...
const Sidebar = () => {
  ...
  return (
    <aside className={`h-full border-r p-4 md:p-5 ${selectedUser ? 'max-md:hidden' : 'flex'} flex-col ${isDark ? 'border-white/10 bg-gradient-to-b from-slate-900/60 via-slate-900/35 to-slate-950/35' : 'border-slate-200 bg-gradient-to-b from-white via-slate-50 to-slate-100/80'}`}>
